    ...
    <main className="flex-1 px-5 pb-16 pt-6 md:px-16">
      <div className="mx-auto max-w-250">
        ...
        <div className="mt-8 grid grid-cols-1 items-stretch gap-5 md:grid-cols-[340px_1fr]">
          <nav
            className="flex flex-col gap-3.5 rounded-[10px] border border-white px-5 py-2.5"
          ...
          <section
            ...
            aria-live="polite"
          >
            <p className="mb-4 font-mono text-lg font-bold leading-none tracking-normal text-[#000000] md:mb-6 md:text-[26px]">
              {active.question}
            </p>
            <br></br>
            <p className="mb-4 font-mono text-lg font-bold leading-none tracking-normal text-[#000000] md:mb-6 md:text-[26px]">
